...
The player can selectively increase certain stats of the character. This can come from specific points in attributes, or via some kind of skill or talent tree which provides power-increasing effects via passive or new active effects and abilities. These can be presented in a variety of ways, with some being mutually exclusive choices, or having a limited capacity.
