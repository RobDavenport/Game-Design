Classes are often the broadest denominator when discussing games which feature a wide variety of playstyles and [[Character Roles]]. 
# None
Classes are not picked by the player, but are instead defined by other means.
# Onset
